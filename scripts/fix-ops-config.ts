  ...
  const tiers = [
    {
      ...
      badgeText: "Comercio",
      badgeColor: "gray",
      benefitsJson: JSON.stringify(["Comisión estándar 10%", "Soporte por chat"]),
      displayOrder: 0,
    },
    {
      tier: "PLATA",
      ...
      badgeText: "Destacado",
      badgeColor: "blue",
      benefitsJson: JSON.stringify(["Comisión reducida 9%", "Soporte prioritario", "Badge visible para compradores"]),
      displayOrder: 1,
    },
    {
      tier: "ORO",
      ...
      badgeText: "Popular",
      badgeColor: "yellow",
      benefitsJson: JSON.stringify(["Comisión reducida 8%", "Soporte VIP", "Posición destacada en búsqueda", "Badge dorado"]),
      displayOrder: 2,
    },
    {
      tier: "DIAMANTE",
      ...
      badgeText: "Elite",
      badgeColor: "purple",
      benefitsJson: JSON.stringify(["Comisión mínima 7%", "Account manager dedicado", "Primera posición en categoría", "Badge diamante", "Acceso a analytics avanzados"]),
      displayOrder: 3,
    },
  ];
