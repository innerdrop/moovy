            ...
            <div className="relative z-10 container mx-auto px-4 py-8 md:py-12 lg:py-16">
                <div className="max-w-2xl mx-auto lg:mx-0">
                    ...
                    <p className="text-white/85 text-base sm:text-lg font-medium mb-6 max-w-lg">
                        Pedidos de comercios locales, marketplace entre vecinos y mucho más
                    </p>

                    {/* Search bar */}
                    <form onSubmit={handleSubmit} className="relative max-w-md">
                        <div className="flex items-center bg-white rounded-xl shadow-lg shadow-black/15 overflow-hidden">
