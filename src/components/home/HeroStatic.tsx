...
const TYPE_CONFIG = {
    ...
    marketplace: { label: "Marketplace", color: "bg-purple-100 text-purple-700", icon: Tag },
} as const;
...
export default function HeroStatic({ totalDelivered = 0, activeMerchants = 0 }: HeroStaticProps) {
    ...
    return (
        <section className="relative" style={{ zIndex: 10 }}>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ background: "linear-gradient(135deg, #b80000 0%, #d50000 25%, #e60012 50%, #ff1a2e 75%, #ff3d4d 100%)" }}>
                ...
                <div
                    ...
                    style={{
                        background: "linear-gradient(115deg, transparent 30%, rgba(255,255,255,0.6) 45%, rgba(255,255,255,0.3) 55%, transparent 70%)",
                    }}
                />
                {/* === LAYER 3: Organic floating shapes === */}
                <div
                    className="absolute -top-20 -right-20 w-80 h-80 rounded-full"
                    style={{ background: "radial-gradient(circle, rgba(255,255,255,0.08) 0%, transparent 70%)", animation: "hero-float 8s ease-in-out infinite" }}
                />
                <div
                    className="absolute -bottom-10 -left-16 w-56 h-56 rounded-full"
                    style={{ background: "radial-gradient(circle, rgba(255,200,100,0.06) 0%, transparent 70%)", animation: "hero-float 10s ease-in-out infinite 2s" }}
                />
                <div
                    className="absolute top-1/3 right-8 w-24 h-24 rounded-full"
                    style={{ background: "radial-gradient(circle, rgba(255,255,255,0.06) 0%, transparent 70%)", animation: "hero-float 6s ease-in-out infinite 1s" }}
                />
                ...
                <div className="absolute -bottom-px left-0 right-0 z-20" style={{ lineHeight: 0 }}>
                    <svg viewBox="0 0 1440 100" xmlns="http://www.w3.org/2000/svg" className="w-full block absolute bottom-0" preserveAspectRatio="none" style={{ height: '55px' }}>
                        <path d="M0 45C180 85 360 15 540 50C720 85 900 20 1080 55C1260 90 1380 35 1440 60V100H0Z" fill="rgba(255,255,255,0.4)" />
                    </svg>
                    <svg viewBox="0 0 1440 100" xmlns="http://www.w3.org/2000/svg" className="w-full block relative" preserveAspectRatio="none" style={{ height: '50px' }}>
                        <path d="M0 55C200 95 440 10 720 60C1000 110 1240 25 1440 70V100H0Z" fill="#ffffff" />
                    </svg>
                </div>
            </div>
            ...
            <div className="relative z-10 container mx-auto px-4 pt-8 pb-16 md:pt-12 md:pb-20 lg:pt-16 lg:pb-24">
                <div className="lg:flex lg:items-center lg:justify-between">
                    <div className="max-w-2xl mx-auto lg:mx-0">
                        ...
                        <div ref={dropdownRef} className="relative max-w-md z-30">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    {s.extra && (
                                                        <div className="text-xs text-gray-500 truncate">{s.extra}</div>
                                                    )}
                                                </div>
                                                {/* Type badge + price */}
