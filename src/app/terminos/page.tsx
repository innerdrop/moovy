...
export const metadata = {
    ...
    description: 'Conoce los términos y condiciones de uso de Moovy.',
};
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 space-y-6 text-gray-700">
                <section>
                    <h2 className="text-xl font-bold text-moovy-dark mb-3">1. Introducción</h2>
                    <p>
                        Bienvenido a Moovy. Al acceder y utilizar nuestro sitio web y servicios, aceptas cumplir con los siguientes términos y condiciones.
                        Si no estás de acuerdo con alguna parte de estos términos, te recomendamos no utilizar nuestros servicios.
                    </p>
                </section>

                <section>
                    <h2 className="text-xl font-bold text-moovy-dark mb-3">2. Uso del Servicio</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-moovy-dark mb-3">3. Pedidos y Precios</h2>
                    <p>
                        ...
                        Moovy se reserva el derecho de modificar los precios en cualquier momento. El costo del envío se calculará al momento de finalizar la compra.
                    </p>
                </section>

                <section>
                    <h2 className="text-xl font-bold text-moovy-dark mb-3">4. Envíos y Entregas</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-moovy-dark mb-3">5. Política de Devoluciones</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-moovy-dark mb-3">6. Propiedad Intelectual</h2>
                    <p>
                        Todo el contenido de este sitio, incluyendo logotipos, textos, imágenes y diseño, es propiedad de Moovy y está protegido por las leyes de propiedad intelectual vigentes.
                    </p>
                </section>

                <section>
                    <h2 className="text-xl font-bold text-moovy-dark mb-3">7. Contacto</h2>
                    <p>
                        Para cualquier duda o consulta relacionada con estos términos, podés contactarnos a través de nuestra sección de <a href="/contacto" className="text-moovy font-semibold hover:underline">Contacto</a>.
                    </p>
                </section>
