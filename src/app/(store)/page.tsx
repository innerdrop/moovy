    ...
    return (
        <div className="group border border-gray-100 rounded-xl overflow-hidden bg-white hover:shadow-md transition-shadow">
            ...
            <div className="p-3 relative">
                {/* Add to cart button */}
                <button className="absolute -top-4 right-3 w-8 h-8 bg-[#e60012] hover:bg-[#c4000f] text-white rounded-xl flex items-center justify-center text-lg font-bold shadow-md border-[3px] border-white transition-transform hover:scale-110 z-10">
        ...
        <div className="animate-fadeIn">
            ...
            <section className="py-4 bg-white">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex gap-3 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-2 -mx-4 px-4 lg:mx-0 lg:px-0" style={{ scrollbarWidth: "none" }}>
                        {categories.map((cat) => (
                            <Link
                                key={cat.id}
                            ...
                            >
                                <div className="w-20 lg:w-28 flex flex-col items-center gap-2">
                                    <div className="w-16 h-16 lg:w-20 lg:h-20 rounded-2xl overflow-hidden bg-gray-100 border-2 border-gray-100 group-hover:border-[#e60012]/40 group-hover:shadow-lg transition-all duration-300 group-hover:scale-105">
                                        {cat.image ? (
                                            <img
                                                src={cat.image}
                                                alt={cat.name}
                                    ...
                                    <span className="text-xs font-semibold text-gray-600 group-hover:text-[#e60012] transition-colors text-center truncate w-full">
                                        {cat.name}
                                    </span>
                                </div>
                            </Link>
