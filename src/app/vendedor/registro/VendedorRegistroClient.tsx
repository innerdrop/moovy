...
function SellerRegistroContent() {
    ...
    // NOTA: el guard "si ya es SELLER redirigir al dashboard" ahora vive en
    // src/app/vendedor/registro/page.tsx como Server Component, usando
...
export default function VendedorRegistroClient() {
    return (
        <Suspense fallback={
