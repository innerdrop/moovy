/**
 * GET /api/admin/merchants/[id]/change-requests
 *
 * Lista las solicitudes de cambio de documentos del merchant. Usado en la
 * pantalla del detalle de merchant en OPS para mostrar qué docs están pedidos
...
export async function GET(
    ...
    try {
        ...
        // Confirma que exista (y nos deja usar el nombre en la respuesta).
        ...
        // Resolver names para los IDs de resolvedBy (batch, una sola query).
        ...
        console.error("[AdminChangeRequestsList] Error:", error);
        return NextResponse.json(
