// API Route: Driver verifica el PIN de entrega al comprador (deliveryPin)
// POST /api/driver/orders/[id]/verify-delivery-pin
...
const pinLogger = logger.child({ context: "verify-delivery-pin" });
...
export async function POST(
    ...
    const limited = await applyRateLimit(request, "pin:verify-delivery", 5, 10 * 60 * 1000);
    ...
    try {
        ...
        pinLogger.error({ error }, "Error verifying delivery PIN");
        return NextResponse.json(
