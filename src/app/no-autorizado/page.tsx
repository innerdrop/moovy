    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 max-w-md w-full text-center space-y-6">
                ...
                {/* 403 badge */}
                <div className="inline-block px-4 py-1 bg-red-50 rounded-full text-sm font-mono text-red-500">
                    403
                </div>
                ...
                <div>
                    ...
                    <p className="text-gray-500 mt-2">
                        No tenés permisos para acceder a esta sección. Si creés que es un error, intentá iniciar sesión con otra cuenta.
                    </p>
                </div>
