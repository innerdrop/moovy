    ...
    if (isLoading && !dashboardData) {
        return (
            <div className="h-dvh flex flex-col bg-white">
                {/* Map skeleton */}
                <div className="mx-4 mt-4 h-[220px] rounded-[24px] bg-gray-100 animate-pulse" />

                {/* Stats skeleton */}
                <div className="px-4 pt-6 space-y-6">
                    {/* Status bar skeleton */}
                    <div className="flex items-center justify-between bg-white p-5 rounded-[24px] border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[0, 1].map(i => (
                            <div key={i} className="bg-white border border-gray-100 rounded-[22px] p-4">
                                <div className="w-9 h-9 bg-gray-100 rounded-xl mb-2 animate-pulse" />
                                <div className="h-6 w-20 bg-gray-100 rounded-lg mb-1 animate-pulse" />
                ...
                <div className="flex-1 flex items-end justify-center pb-8">
                    <div className="flex flex-col items-center gap-2">
                        <Bike className="w-8 h-8 text-gray-200" />
                        <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">Cargando moovy...</p>
                    </div>
                </div>
            </div>
        );
