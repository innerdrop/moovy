                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400">Estamos revisando tu DNI, licencia y datos del vehículo</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-gray-400">Repartidor aprobado</p>
                                    <p className="text-xs text-gray-300">Vas a poder conectarte y empezar a recibir pedidos</p>
                                </div>
                            </div>
                        </div>
                    </div>
