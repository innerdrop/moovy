                                        ...
                                        <tr key={product.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="p-4">
                                                {product.categories.map((pc) => (
                                                    <span
                                                        key={pc.category.id}
                                                        className="inline-block bg-moovy-light text-navy text-xs px-2 py-1 rounded-full mr-1"
                                                    >
                                                        {pc.category.name}
                                                    </span>
                                                ))}
                                            ...
                                            <td className="p-4 text-right font-bold text-moovy">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <div className="grid md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <div className="input bg-moovy-light text-moovy font-bold text-center">
                            $0
                        </div>
                    </div>
                    <div>
