# MOOVY
Última actualización: 2026-04-17 (rama `fix/ride` RESUELTA — UX driver portal: 3 Ramas completas. R1 botones flotantes + BottomSheet 2 snaps + CSP wasm-unsafe-eval + gmp-click. R2 polyline matching + instrucciones navegación real-time + re-fetch por desvío. R3 wrapper Routes API con feature flag + branch en RiderMiniMap.)
