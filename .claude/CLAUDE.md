# MOOVY
Última actualización: 2026-04-15 (Fix puntos EARN + mover award a DELIVERED + reversión en cancel/reject/refund + fix acceso /repartidor via proxy + auto-desconexión driver al cambiar de portal)
