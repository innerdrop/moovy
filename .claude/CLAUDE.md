# MOOVY
Última actualización: 2026-04-18 (rama `fix/merchant-schedule-detail` RESUELTA — detail page del comercio ahora respeta el horario real en timezone de Ushuaia + widget expandible con los 7 días visible al buyer. Bug previo: el banner "CERRADO" dependía de `merchant.isOpen` crudo (pausa manual), ignorando `scheduleJson`, y el buyer nunca veía los horarios.)
